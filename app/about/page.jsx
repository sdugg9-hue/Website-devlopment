...
export default function page() {
    return(
      <div className="min-h-screen bg-pink-100 relative overflow-hidden py-16">
      <div className="absolute -right-45 -top-40 w-[700px] h-[300px] bg-pink-300 blur-3xl rounded-full opacity-70"></div>
      <div className="absolute -left-45 -bottom-40 w-[700px] h-[300px] bg-pink-300 blur-3xl rounded-full opacity-70"></div>
     <motion.section
      initial={{ opacity: 0, y: 40 }}
      whileInView={{ opacity: 1, y: 0 }}
      transition={{ duration: 0.8 }}
      viewport={{ once: true, amount: 0.2 }}
      className ="min-h-[30vh] snap-start flex flex-col justify-start pt-24"
    >
       <h1
        ...
        >
         ...
         <div className="max-w-10xl space-y-3 mb-4">
          <p
            className={`relative text-2xl font-bold text-black tracking-wide mt-5 ml-12 ${arm.className}`}>
  ...
  transition={{ duration: 0.8 }}
  viewport={{ once: true, amount: 0.2 }}
  className="min-h-[40vh] snap-start flex items-start px-10 pt-10"
>
  <div className="w-full max-w-[1400px] flex gap-10 items-center">
    <motion.div
    ...
    <motion.div
      ...
      transition={{ duration: 0.8 }}
      viewport={{ once: true, amount: 0.2 }}
      className={`flex-1 space-y-6 ${arm.className}`}
    >
